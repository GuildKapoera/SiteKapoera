	...
	<section class="hero-section">
		<div class="hero-slider owl-carousel">
			<div class="hs-item set-bg" data-setbg="img/slider-1.jpg">
				<div class="hs-text">
					<div class="container">
						<h2>The  <span>Kapoera</span> </h2>
						<p>Kapfather forever. Playing in memory of Najiwus, the prodigal son of Nalanah and Aargonos, <br> also known as the Don of the Kapoeras.  </p>
						<!-- <a href="#" class="site-btn" target="_blank">Read More</a> -->
					</div>
				</div>
			</div>
	...
	<div class="latest-news-section">
		...
		<div class="news-ticker">
			<div class="news-ticker-contant">
				<div class="nt-item"><span class="new">new</span>Pisco ainda não tomou ban hoje!! </div>
				<div class="nt-item"><span class="strategy">Atenção</span>Cuidado, o comensal da morte esta solto! </div>
				<div class="nt-item"><span class="racing">Novidade</span> Alllllllllll llllllllexxxx ficou trapado de novo, mas não é novidade! </div>
			</div>
		</div>
	</div>
	...
	<footer class="footer-section">
		<div class="container">
			<ul class="footer-menu">
				...
				<li><a href="review.html">Servidor</a></li>
				<li><a href="categories.html">Noticias</a></li>
				<li><a href="community.html">Mercado</a></li>
